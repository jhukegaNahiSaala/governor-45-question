...
console.log("test for equality in strings (false)", "apple" === "Apple");
console.log("test for inequality in strings (true)", "apple" !== "orange");
console.log("test for inequality in strings (false)", "apple" !== "apple");
...
console.log("test for equality with numbers (true)", 10 !== 5); //inequality
console.log("test for equality with numbers (false)", 10 !== 10); //inequality
...
const cities = ["karachi", "Hyderabad", "hooriabad"];
